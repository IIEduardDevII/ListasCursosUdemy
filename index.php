<?php
//TODO: requerimos la clase que creamos para los iconos de social media
...
//TODO: requerimos la clase que creamos para los cursos del menù
    require_once("models/Lenguajes.php");
    $lenguajes = new Lenguajes();
    $lenx = $lenguajes->get_lenguajes();
    //print_r($lenx);

//TODO: requerimos la clase que creamos para los cursos destacados  
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <p class="text-muted"><span class="typewrite d-inline" data-period="2000" data-type='[ " Desarrollador Web. ", "Analista de Calidad. ", "Analista de Datos " ]'></span></p>
                        <h2>Hola, Soy <span>Eduard</span></h2>
                        <h3 class="mb-20"> Bienvenidos a mi web</h3>
                        <h5 class="text-muted">Cursos que actualmente estoy tomando</h5>
                    </div>
...
<!--TODO: Carrousel-->
                                ...
                                <div class="position-relative post-thumb">
                                    <div class="thumb-overlay img-hover-slide position-relative" style="background-image: url(assets/imgs/banners/<?php echo $curdx[$i]["cur_img"] ?>)">
                                        ...
                                        <div class="post-content-overlay text-white ml-30 mr-30 pb-30">
                                            <div class="entry-meta meta-0 font-small mb-20">
                                                ...
                                                <a href="category.html"><span class="post-cat text-white text-uppercase"><?php echo $row["det_nom"] ?></span></a>
                                            ...
                                            <p class="text-white" href="single.html"><?php echo $curdx[$i]["cur_subtitulo"] ?></p>
                                        </div>
                                    </div>
                                </div>
...
<!--TODO: Cursos-->
                        ...
                        <article class="col-lg-4 col-md-6 mb-30 wow fadeInUp animated" data-wow-delay="0.2s">
                            <div class="post-card-1 border-radius-10 hover-up">
                                <div class="post-thumb thumb-overlay img-hover-slide position-relative" style="background-image: url(assets/imgs/banners/<?php echo $curx[$i]["cur_img"] ?>)">
                                ...
                                <div class="post-content p-30">
                                    <div class="entry-meta meta-0 font-small mb-10">
                                        ...
                                        ?>
                                            ...
                                            <a href="category.html"><span class="post-cat text-info text-uppercase"><?php echo $row["det_nom"] ?></span></a>
